...
exports.AlonhadatScraper = exports.NhaScraper = exports.BatDongSanScraper = exports.ScraperOrchestrator = void 0;
const batdongsanScraper_1 = require("./batdongsanScraper");
Object.defineProperty(exports, "BatDongSanScraper", { enumerable: true, get: function () { return batdongsanScraper_1.BatDongSanScraper; } });
const nhaScraper_1 = require("./nhaScraper");
Object.defineProperty(exports, "NhaScraper", { enumerable: true, get: function () { return nhaScraper_1.NhaScraper; } });
const alonhadatScraper_1 = require("./alonhadatScraper");
Object.defineProperty(exports, "AlonhadatScraper", { enumerable: true, get: function () { return alonhadatScraper_1.AlonhadatScraper; } });
...
class ScraperOrchestrator {
    constructor() {
        ...
        this.dbConnection = database_1.DatabaseConnection.getInstance();
        this.session = {
        ...
        // Initialize scrapers
        this.scrapers.set('batdongsan', new batdongsanScraper_1.BatDongSanScraper());
        this.scrapers.set('nha', new nhaScraper_1.NhaScraper());
        this.scrapers.set('alonhadat', new alonhadatScraper_1.AlonhadatScraper());
    }
    /**
     ...
     */
    async runAllScrapers(propertiesPerSite = 50) {
        ...
        try {
            ...
            for (const [name, scraper] of this.scrapers) {
                ...
                if (this.scrapers.size > 1) {
                    console.log(`⏳ Waiting ${scrapers_1.globalConfig.retryDelay / 1000}s before next scraper...`);
                    await dataProcessor_1.DataProcessor.delay(scrapers_1.globalConfig.retryDelay, scrapers_1.globalConfig.retryDelay + 2000);
                }
            }
     ...
     */
    async runScraper(scraperName, maxProperties = 50) {
