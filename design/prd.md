...
graph TB
    ...
    subgraph "Backend Services"
        ...
        Upload[Upload & Analysis Service]
        Similar[Similar Property Engine]
    end
    
    %% Data Collection Layer
    subgraph "Data Collection"
        Scrapy[Scrapy Orchestrator]
    ...
    subgraph "ML & Analytics"
        ...
        SimilarityAI[Similarity Matching AI]
    end
    ...
    class Gateway,Auth,JWT,API,ML,AVM,Export,Upload,Similar backend
    class PostgreSQL,Redis,S3 data
    class Models,Training,Analytics,ImageAI,SimilarityAI ml
    class BDS,AHD,Other external
```
