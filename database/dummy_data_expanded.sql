...
-- (Data will be populated by the automated script)
...
-- Insert all Vietnamese cities/provinces as reference data for city/province lookup. This will be used for robust address normalization in the scraper.
